...
class ChangeKeyConfirmation extends \BuddyBot\Admin\Html\Modals\MoRoot
{
    protected $modal_id = 'buddybot-change-key-confirmation-modal';
    ...
    {
        echo '<button type="button" class="btn btn-secondary btn-sm" id="buddybot-change-key-cancel-btn" data-bs-dismiss="modal">' . esc_html__('Cancel', 'buddybot-ai-custom-ai-assistant-and-chat-agent') . '</button>';
