...
class ChatBubble extends \BuddyBot\Admin\Html\Elements\Playground\MoRoot
{
    ...
    protected function userMessageHtml()
    {
        ...
        $html = '<div class="buddybot-playground-messages-list-item buddybot-d-flex   buddybot-my-2 buddybot-justify-content-end buddybot-align-self-end" id="' . esc_attr($this->message->id) . '">';

        $html .= $this->messageImage($img_url);

        $html .= '<div>';

        $html .= '<div class=" buddybot-bg-primary buddybot-text-white buddybot-border-radius-20 buddybot-ms-2 buddybot-text-break buddybot-px-3 buddybot-py-2 buddybot-align-self-end buddybot-fs-6">';
    ...
    protected function assistantMessageHtml()
    {
        ...
        $html = '<div class="buddybot-playground-messages-list-item buddybot-d-flex  buddybot-my-2 sss" id="' . esc_attr($this->message->id) . '">';

        $html .= $this->messageImage($img_url);

        $html .= '<div>';

        $html .= '<div class="buddybot-p-2 buddybot-bg-light buddybot-border-radius-20 ">';
    ...
    {
        $html = '<div class="me-2">';
        $html .= '<img width="28" class="rounded-circle buddybot-border-radius-50" src="' . esc_url($img_url) . '">';
        $html .= '</div>';
        return $html;
    }
    ...
    private function messageDate()
    {
        ...
        $html = '<div class="buddybot-text-muted buddybot-text-small  buddybot-text-align-right buddybot-mt-2 buddybot-me-2">';
    ...
    protected function parseFile($file_id)
    {
        ...
        $html = '<div class="buddybot-mt-2 buddybot-bg-dark buddybot-p-3 rounded-3 buddybot-d-flex buddybot-align-items-center">';
        ...
        $html .= '<div class="small buddybot-fw-bold">';
    ...
    protected function parseImage($image_id)
    {
        ...
        $html = '<div class="buddybot-mb-2 buddybot-bg-secondary bg-opacity-10 buddybot-p-3 rounded-3">';
