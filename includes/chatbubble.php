...
final class ChatBubble extends \BuddyBot\Admin\MoRoot
{
    ...
    private function threadList()
    {
        ...
        foreach ($this->response['result'] as $thread) {
            ...
            echo '<div class="buddybot-threads-container buddybot-d-flex buddybot-justify-content-between buddybot-align-items-center buddybot-mt-4">';
            ...
            echo '</div>'; 
                esc_html_e($date);    
            echo '</div>';
            echo '<div class="buddybot-delete-icon buddybot-ms-1 buddybot-me-3 buddybot-d-none" style="cursor:pointer" data-modal="buddybot-del-conversation-modal">   
