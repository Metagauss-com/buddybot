...
final class ChatBubble extends \BuddyBot\Admin\MoRoot
{
    ...
    public function getHtml($response)
    {
        ...
        // $this->test();
        echo '<div class="buddybot-row-container buddybot-mt-4 buddybot-p-1 buddybot-bg-lightBlue " style="min-height:60vh;border-radius:20px;" >';
...
private function chatBuubbleLeft()
{
    ...
    echo '<h4>CHATs</h4>';
    echo '<button class="buddybot-btn-new-thread buddybot-bg-primary buddybot-border-radius-5 buddybot-fw-medium">New Chat+</button>';
    ...
    {
       echo '<div class="buddybot-d-flex buddybot-flex-column buddybot-align-items-center buddybot-h-100 buddybot-position-relative" style="height: 92vh;">';
       ...
       echo '<div class="buddybot-chat-input-wrapper buddybot-p-2 buddybot-position-sticky buddybot-bottom-0 buddybot-box-w-100 buddybot-d-none-flex buddybot-align-items-center buddybot-p-2  buddybot-my-2 buddybot-px-3" style="max-width:800px;">';
       echo '<textarea id="buddybot-chat-input" class="buddybot-box-w-100 buddybot-overflow-y buddybot-bg-white  buddybot-fs-6 buddybot-p-3" placeholder="Type your message..." rows="3" "></textarea>';
       echo '<button id="buddybot-send-btn" class="buddybot-position-absolute buddybot-p-2 buddybot-cursor-pointer buddybot-bg-white  buddybot-text-dark buddybot-d-flex buddybot-align-items-center buddybot-justify-content-center buddybot-border-radius-50" aria-label="Send message" disabled >';
