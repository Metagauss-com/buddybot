...
trait SingleConversation
{
    ...
    private function visitorAlertContainer() {
        ...
        $html .= '<div id="buddybot-popover-1" class="buddybot-popover">You will not be able to access your chat history permanently because you are not logged in. If you log in, you can save and access your conversations later.</div>';
        $html .= '</div>';
        return $html;
    }
